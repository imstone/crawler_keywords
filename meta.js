...
var input = fs.createReadStream(__dirname + '/fhl_clireq_httphost_pv.txt');
var writable = fs.createWriteStream(__dirname + '/wubin1.txt');
var wubinError = fs.createWriteStream(__dirname + '/wubinError.txt');
